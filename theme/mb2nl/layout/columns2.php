...
// Fix calendar view in Moodle 3.4 because of calendar template bug
// Fix badge view in Moodle 3.4 and 3.5
$divFix = '';
$badgeCase = ($CFG->version >= 2017111300 && $PAGE->pagetype === 'badges-badge' && preg_match('@hash@',$PAGE->url->get_query_string()));
$calendarCase = ($CFG->version >= 2017111300 && $CFG->version < 2018051700 && $PAGE->pagetype === 'calendar-view');


if ($badgeCase || $calendarCase)
{
	$divFix = '</div>';
}
