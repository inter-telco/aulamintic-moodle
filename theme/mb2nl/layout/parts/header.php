...
<div id="page-outer" style="background-color:#ffffff;">
<div id="page">
<div id="page-a">
...
<?php else : ?>
    <div id="main-header">
	 ...
	 <?php if (theme_mb2nl_isblock($PAGE, 'banner-top')) : ?>
		 <?php echo $OUTPUT->blocks('banner-top', theme_mb2nl_block_cls($PAGE, 'banner-top','none')); ?>
	 <?php endif; ?>
    <?php if ($menuPos == 1 && theme_mb2nl_theme_setting($PAGE, 'stickynav', 0) == 1) : ?>
