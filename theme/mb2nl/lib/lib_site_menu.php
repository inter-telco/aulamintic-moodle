...
function theme_mb2nl_site_menu()
{
	...
	$siteMenuIems = explode(',',theme_mb2nl_theme_setting($PAGE,'sitemnuitems','frontpage,calendar,badges,courses,addcourse,editcourse'));
	...
	if (theme_mb2nl_theme_setting($PAGE,'sitemnu'))
	{
   ...
   if ($PAGE->user_is_editing())
   {
	...
	$items = array(
		'addcourse' => array(
			...
			'link' => new moodle_url($CFG->wwwroot . '/course/edit.php',array('category'=>theme_mb2nl_get_category()->id))
		),
		'addcategory' => array(
