...
$temp->add($setting);
	...
	$name = 'theme_mb2nl/roleshortname';
	$title = get_string('roleshortname','theme_mb2nl');
...
$temp->add($setting);
	...
	$name = 'theme_mb2nl/loginsearchspacer';
...
$temp->add($setting);
	...
	$setting = new admin_setting_configtextarea($name, $title,get_string('sitemnuitemsdesc','theme_mb2nl'),'frontpage,calendar,badges,courses,addcourse,editcourse');
	$setting->set_updatedcallback('theme_reset_all_caches');
	$temp->add($setting);
