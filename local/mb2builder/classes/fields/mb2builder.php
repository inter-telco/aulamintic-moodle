...
if (!class_exists('admin_setting_configmb2builder') && class_exists('admin_setting'))
{
	...
	class admin_setting_configmb2builder extends admin_setting
	{
		...
		public function output_html($data, $query='')
		{
			...
			$output = '';
			$output .= '</div></div>';
			$output .= '<div class="mb2-pb-container mb2-pb-builder-' . $builder_id . '" data-pageid="' . $builder_id . '">';
		...
		public function local_mb2builder_layout_builder_section($section)
		{
			...
			$output .= '<div class="mb2-pb-section" ' . $this->local_mb2builder_layout_builder_get_settings($section['settings']) . '>';
		...
		public function local_mb2builder_layout_builder_row($row)
		{
			...
			$output .= '<div class="mb2-pb-row" ' . $this->local_mb2builder_layout_builder_get_settings($row['settings']) . '>';
		...
		public function local_mb2builder_layout_builder_toolbar($id)
		{
			...
			$output .= '<a href="#" data-toggle="modal" data-target="#mb2-pb-modal-import-export-' . $id . '">' . get_string('importexport','local_mb2builder') . '</a>';
