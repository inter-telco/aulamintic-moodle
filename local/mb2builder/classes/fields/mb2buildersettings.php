	...
	class admin_setting_configmb2buildersettings extends admin_setting
	{
		...
		public function local_mb2builder_settings_get_settings_template ($config_fields, $type)
		{
			...
			foreach ($config_tabs as $tab=>$tname)
			{
				...
				$output .= '<li class="' . $isactive . '"><a data-toggle="tab" href="#' . $type . '-' . $tab . '">' . $tname . '</a></li>';
			}
		...
		public function local_mb2builder_settings_get_modal ($type)
		{
			...
			if ($type === 'images' || $type === 'font-icons')
			{
				$modal_cls = ' modal-md';
			}
			...
			if ($type !== 'row-layout' && $type !== 'elements')
			{
				...
				$output .= $save_btn ? '<button type="button" id="' . $btn_id . '" class="btn btn-sm btn-success"' . $dismiss . '>' . get_string('save') . '</button>' : '';
		...
		public function local_mb2builder_font_icons()
		{
			...
			$output .= '<ul class="nav nav-tabs">';
			$output .= '<li class="active"><a data-toggle="tab" href="#tab-font-icons-fa">Font Awesome</a></li>';
			$output .= '<li><a data-toggle="tab" href="#tab-font-icons-glyph">Glyphicons</a></li>';
			$output .= '<li><a data-toggle="tab" href="#tab-font-icons-7stroke">7 Stroke</a></li>';
			$output .= '</ul>';
		...
		public function local_mb2builder_import_export($id)
		{
			...
			$output .= '<ul class="nav nav-tabs">';
			$output .= '<li class="active"><a data-toggle="tab" href="#tab-import' . $id . '">' . get_string('import','local_mb2builder') . '</a></li>';
			$output .= '<li><a data-toggle="tab" href="#tab-export' . $id . '">' . get_string('export','local_mb2builder') . '</a></li>';
			$output .= '</ul>';
			...
			$output .= '<a href="' . $this->local_mb2builder_settings_export_page($id) . '" download>' . get_string('downloadcontent' . $id,'local_mb2builder') . '</a>';
			$output .= '</div>';
