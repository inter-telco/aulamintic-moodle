...
$string['margindesc'] = 'Margin top right bottom left, for eaxample: 10px 15px 30px 15px';
$string['title'] = 'Title';
$string['text'] = 'Text';
...
$string['icon'] = 'Icon';
$string['selecticon'] = 'Select icon';
$string['videoidlabel'] = 'Web video ID';
$string['videoiddesc'] = 'Youtube or Vimeo video id. Get video id from url:<br><strong>Youtube:</strong> youtube.com/watch?v=<strong>VIDEO_ID_IS_HERE</strong><br><strong>Vimeo:</strong> vimeo.com/<strong>123456789</strong>';
...
$string['uploadimages'] = 'Upload image';
